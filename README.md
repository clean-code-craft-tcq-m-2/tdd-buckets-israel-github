...
- What is the maximum complexity (CCN) per function? 7 (current complexity level, can be reduced) CCN and create corresponding yml in the `.github/workflows` folder
